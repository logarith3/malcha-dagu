...
from .services import AIDescriptionService, SearchAggregatorService
...
class InstrumentViewSet(viewsets.ModelViewSet):
    ...
    GET    /api/instruments/          - 목록
    POST   /api/instruments/          - 생성 (관리자용)
    GET    /api/instruments/{id}/     - 상세
    PUT    /api/instruments/{id}/     - 수정 (관리자용)
    DELETE /api/instruments/{id}/     - 삭제 (관리자용)
    """
...
class UserItemViewSet(viewsets.ModelViewSet):
    ...
    POST   /api/items/{id}/click/   - 클릭 추적 + 만료 연장
    """
    ...
    def create(self, request, *args, **kwargs):
        print("DEBUG: UserItemViewSet.create called")
        print("DEBUG: request.data:", request.data)
        response = super().create(request, *args, **kwargs)
        print("DEBUG: create success, response:", response.data)
        return response
